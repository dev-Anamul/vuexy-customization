  ...
  const handleFilter = e => {
    ...
    if (value.length) {
      updatedData = data.filter(item => {
        const startsWith =
          actvieOrNot(item)?.toLowerCase().startsWith(value.toLowerCase()) ||
          item.countryID.toString().toLowerCase().startsWith(value.toLowerCase()) ||
        ...
        const includes =
          item.readPermission?.toLowerCase().includes(value.toLowerCase()) ||
