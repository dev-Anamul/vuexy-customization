...
const UserInfoCard = ({ selectedUser }) => {
  ...
  // ** render user img
  const renderUserImg = () => {
    if (selectedUser !== null && selectedUser.photoPath.length) {
      return (
        <img
          height='110'
          width='110'
              ...
              <ul className='list-unstyled'>
                ...
                <li className='mb-75'>
                  ...
                  <Badge className='text-capitalize' color={statusColors[selectedUser.status]}>
                    {selectedUser.isAccountActive ? 'Active' : 'Inactive'}
                  </Badge>
                </li>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Role:</span>
                  <span className='text-capitalize'>{selectedUser.roleID}</span>
                </li>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Tax ID:</span>
                  {/* <span>Tax-{selectedUser.cellPhone.substr(selectedUser.contact.length - 4)}</span> */}
                  <span>Tax-{selectedUser.cellphone}</span>
                </li>
                <li className='mb-75'>
            ...
            <Row className='gy-1 pt-75'>
              ...
              <Col md={6} xs={12}>
                ...
                <Select
                  ...
                  defaultValue={statusOptions[statusOptions.findIndex(i => i.value === 'active')]}
                />
              </Col>
              <Col md={6} xs={12}>
                ...
                <Input
                  ...
                  defaultValue={selectedUser.cellphone}
                />
              </Col>
              <Col md={6} xs={12}>
