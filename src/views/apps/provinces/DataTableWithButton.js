...
import AddPorvinceModal from "./AddProvinceModal";
  ...
  const handleFilter = (e) => {
    ...
    if (value.length) {
      updatedData = data.filter((item) => {
        const startsWith =
          item.provinceName.toLowerCase().startsWith(value.toLowerCase()) ||
        ...
        const includes =
          item.provinceName.toLowerCase().includes(value.toLowerCase()) ||
