...
const AddPorvinceModal = ({ open, setOpen, selectedData }) => {
  ...
  const onSubmit = (data) => {
    if (Object.values(data).every((field) => field.length > 0)) {
      ...
      dispatch(updateProvinceData(newProvince));
          ...
          <Card>
            <CardBody>
              <Form onSubmit={handleSubmit(onSubmit)}>
                <div className="mb-1">
                  <Label className="form-label" for="provinceName">
                    Province Name
                  </Label>
                  <Controller
                    defaultValue={selectedData.provinceName}
                    control={control}
                    id="provinceName"
                    name="provinceName"
                    render={({ field }) => (
                      <Input
                        ...
                        invalid={errors.provinceName && true}
                        {...field}
                      />
                    )}
                  />
